...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        // Elevation is declared once: cards sit in the page flow and use a
        // border; floating surfaces (popover, dropdown, dialog, tooltip) use a
        // shadow. A hairline border under a soft shadow is the ghost-card look.
