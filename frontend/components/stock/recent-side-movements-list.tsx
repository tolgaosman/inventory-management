          ...
          <Table>
            <TableHeader>
              <TableRow className="border-b border-border/70 hover:bg-transparent">
                ...
                <TableHead className="px-2 text-center">Miktar / Sebep</TableHead>
                ...
                return (
                  <TableRow key={m.id} className="border-b border-border/50 hover:bg-muted/50 transition-colors">
                    ...
                    <TableCell className="px-2 text-center">
                      <div className={cn("text-xs font-semibold tabular-nums", isGiris ? "text-status-good" : "text-status-critical")}>
                        {isGiris ? "+" : "-"}{formatNumber(m.quantity)}
                      </div>
