  ...
  return (
    <div className="w-full rounded-[32px] bg-white/70 dark:bg-slate-950/60 backdrop-blur-xl p-8 sm:p-10 shadow-[0_8px_32px_-12px_rgba(0,0,0,0.1)] border border-white/50 dark:border-slate-800/50 relative overflow-hidden transition-colors">
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        {/* Demo Logins */}
        <div className="mt-8 w-full border-t border-slate-200 dark:border-slate-800/60 pt-6">
          <h3 className="text-xs font-semibold text-slate-500 dark:text-slate-400 mb-4 text-center uppercase tracking-wider">Demo Hesaplar (Şifre: 12345678)</h3>
          <div className="flex flex-col gap-2">
            {[
              { email: "admin@test.com", role: "Admin" },
              { email: "tolgaosman@sirket.com", role: "Satın Alma Müdürü" },
              { email: "arda.sahin@sirket.com", role: "Satın Alma Personeli" },
              { email: "berk.fenk@sirket.com", role: "Depo Müdürü" },
              { email: "mustafa.haci@sirket.com", role: "Depo Personeli" },
            ].map((account) => (
              <button
                key={account.email}
                type="button"
